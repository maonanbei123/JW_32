(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SchoolComponent = /** @class */ (function () {
                ...
                // DoCheck 触发变更检测机制就是调用DoCheck钩子，目的是保证组件属性和浏览器的显示同步
                SchoolComponent.prototype.ngDoCheck = function () {
                    if (this.currentPag !== this.oldCurrentPag || this.pagNums !== this.oldPagNums) {
                        this.dataShow = [];
                        var curren = this.currentPag - 1;
                        var pagNum = this.pagNums;
                ...
                // 捕获当前显示页码函数
                SchoolComponent.prototype.currentPagHandel = function (pag) {
                    this.currentPag = pag;
                };
                // 捕获每页显示数量行数
                SchoolComponent.prototype.pagNumsHandel = function (pagNum) {
                    this.pagNums = pagNum;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddTeacherComponent = /** @class */ (function () {
                ...
                AddTeacherComponent.prototype.save = function (no, name, title, degree, department) {
                    var _this = this;
